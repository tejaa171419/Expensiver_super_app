...
const InviteMembersModal = ({ isOpen, onClose, groupName, groupId, onInviteSent }: InviteMembersModalProps) => {
  ...
  const handleCopyLink = () => {
    const groupLink = `https://zenithwallet.app/join/${groupId}`;
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full">
          ...
          <TabsContent value="contacts" className="space-y-6 mt-6">
            <div className="space-y-4">
              ...
              {/* Contacts List */}
              <div className="space-y-2 max-h-[300px] overflow-y-auto border border-border/30 rounded-lg p-2 bg-card/20">
                {filteredContacts.map((contact) => (
                  <div
                    key={contact.id}
                    className={cn(
                      "flex items-center gap-4 p-3 rounded-lg border cursor-pointer transition-all duration-200 hover:scale-[1.02]",
            ...
            <div className="space-y-6">
              <Card className="bg-gradient-to-r from-primary/10 to-primary/5 border-primary/20">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-xl font-bold text-foreground mb-2">Group Invitation Link</h3>
                  ...
                  <div className="bg-background/50 border border-border/50 rounded-lg p-4 mb-4">
                    <div className="flex items-center gap-2 text-sm font-mono text-muted-foreground">
                      ...
                      <span className="truncate">https://zenithwallet.app/join/{groupId}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2 justify-center">
                    ...
                    <Button
                      ...
                      className="flex-1 max-w-40 bg-gradient-primary text-white"
                    >
                      <Share2 className="w-4 h-4 mr-2" />
                      Share
                    </Button>
              ...
              <div className="space-y-3">
                <Label className="text-foreground text-base">Custom Share Message</Label>
                <Textarea
                  value={linkMessage}
              ...
              <Card className="bg-card/30 border-border/30">
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <div className="space-y-2">
                      <h4 className="font-medium text-foreground">Share Options</h4>
